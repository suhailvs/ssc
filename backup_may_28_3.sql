...
-- Generation Time: May 28, 2014 at 08:24 AM
...
(1, 'pbkdf2_sha256$12000$ORbc5wcwCMzR$VSycpSSjUkGN1RWxE72c2YVFApf3QqtJdYSAHQvNLW4=', '2014-05-28 00:32:58', 1, 'suhail', '', '', 'suhailvs1@gmail.com', 1, 1, '2014-05-23 07:17:33'),
(2, 'pbkdf2_sha256$12000$w5zvdI4OkpgJ$HTxHrQrfMGjQIKwa6TltDQ5kFSn78WP5sXjPdzM8V0w=', '2014-05-27 13:42:21', 0, 'suhailvs', '', '', 'suhailvs0@gmail.com', 0, 1, '2014-05-23 07:20:39'),
...
(1, 'LATEST_UPDATES_DATETIME', 'eJxLTkksSS3JzE3lgjMKDLk0gtVjKgzMYypSUoG0aUyFYRKENkgGstOAtHFMhSWQbWGqzlUSVGDEpQcAlcIXmw=='),
...
(170, 'UPFILES_FOLDER', 'T[str]/var/lib/openshift/537ed1c5e0b8cdb41100008c/app-root/runtime/repo/forum/upfiles'),
...
--
-- Table structure for table `forum_openidassociation`
--

CREATE TABLE IF NOT EXISTS `forum_openidassociation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `forum_openidassociation`
--

INSERT INTO `forum_openidassociation` (`id`, `server_url`, `handle`, `secret`, `issued`, `lifetime`, `assoc_type`) VALUES
(2, 'https://www.google.com/accounts/o8/ud', '1.AMlYA9WPTrLGhim_BQ9UcLaMs2DveIN0NQZcVdJDmFReEIspJV0K4HQGPEEUqw', 'ShKOK1IOz1sgcXXnON8Ft3jTDNY=\n', 1401208576, 46800, 'HMAC-SHA1');

-- --------------------------------------------------------

--
-- Table structure for table `forum_openidnonce`
--

CREATE TABLE IF NOT EXISTS `forum_openidnonce` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'multitasking', 2, '2014-05-23 07:27:58', 2),
(2, 'qp2013', 2, '2014-05-23 07:27:58', 2),
(3, 'generalintelligence', 2, '2014-05-23 07:27:58', 2);
...
(1, 1, 'pagination', 'eJzTSCkw5ApWDwx1DQ7x9PcLjvfxDA5R5yow4tJIKTDmKg5WDw12DYqHycOkTUDSpiBpRxdfT7/4IFdnV7+QeEfnEM8wz5BIoAozkApzsAq/4HCgEVCdFiBxS7jBqJKGBiBZQ0OuYj0AtBgpyw=='),
(2, 2, 'pagination', 'eJzTSCkw5ApWDwx1DQ7x9PcLjvfxDA5R5yow4tJIKTDmKg5WDw12DYqHycOkTUDSpjBpuC4zkLA5SNjRLzgcqA8qbgESt4SbhippaACSNTTkKtYDAOmkJqM='),
